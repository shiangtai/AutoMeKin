...
energy=` awk 'BEGIN{e=0};/EKMC/{e=$2};END{print e*'$factor'}'  $inputfile `
nmol=1000
...
sort -rg tmp_min/kmcout.log >tmp_min/min_sorted

awk 'BEGIN{m[0]='$imin';i=1;det=0}
{++i;m[i]=$3
++i;m[i]=$2
